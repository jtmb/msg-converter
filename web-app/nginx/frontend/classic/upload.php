...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    ...
    $output = shell_exec('python3 -m extract_msg /var/www/html/classic/'.escapeshellarg($target_file).' --out /var/www/html/converted-messages/uploads/ --prepared-html --use-filename --html ');
